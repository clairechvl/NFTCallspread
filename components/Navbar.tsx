      ...
      <header className="flex md:flex-row flex-col px-3 lg:px-10 justify-between items-center pt-5 space-y-2">
        ...
        {account ? (
          <div className="flex flex-row space-x-3 items-center text-white text-lg">
            <span>{account}</span>
            <div className="bg-white px-2 py-1 border-2 border-green-500 rounded-xl cursor-pointer text-center">
          ...
          <div
            className="bg-white px-2 py-1 border-2 border-purple-500 rounded-xl cursor-pointer text-center"
            onClick={() => {
              loadWallet();
            }}
          >
            <span className="text-xl font-bold text-purple-500">Connect to Web3</span>
          </div>
        )}
      </header>
    </>
